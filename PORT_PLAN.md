...
### Phase J — Content pack (→ 0.7.0) — **shipped**

| ID | Модуль | Статус |
|----|--------|--------|
| J1 | Full research trees: BASICS / AUROMANCY / ARTIFICE / ALCHEMY / GOLEMANCY / ELDRITCH | done |
| J2 | Recipe flood: workbench / crucible / infusion for tools, devices, foci tiers | done |
| J3 | Devices: arcane levitator, mirror, lamp of growth, hungry chest stubs | done |
| J4 | Golem upgrades: cores, accessories, more seals (harvest/use/butcher) | done |
| J5 | Armor/curios set: goggles tiers, traveller boots, cloudstepper, charm slots | done |

### Phase K — World & threats (→ 0.8.0) — **shipped**

| ID | Модуль | Статус |
|----|--------|--------|
| K1 | Structures: eldritch ring, hilltop stones, cultist camp mini | done |
| K2 | Outer lands portal tease (no full dimension) | done |
| K3 | Bosses: Crimson Cult captain → Warden fight phases | done |
