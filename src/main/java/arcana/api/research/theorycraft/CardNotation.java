...
public class CardNotation extends TheorycraftCard {
    ...
    public CompoundTag serialize() {
        ...
        nbt.putString("cat1", cat1 == null ? "" : cat1);
        nbt.putString("cat2", cat2 == null ? "" : cat2);
        return nbt;
    }
    ...
    public String getLocalizedText() {
        return Component.translatable("card.notation.text",
                ChatFormatting.BOLD
                        + Component.translatable("tc.research_category." + cat1).getString()
                        + ChatFormatting.RESET,
                ChatFormatting.BOLD
                        + Component.translatable("tc.research_category." + cat2).getString()
    ...
    public boolean activate(Player player, ResearchTableData data) {
        ...
        data.addTotal(cat2, lVal / 2 + Mth.nextInt(player.getRandom(), 0, Math.max(0, lVal / 2)));
        return true;
    }
}
