...
import arcana.client.gui.WardedJarScreen;
...
import arcana.client.render.CrimsonCultistRenderer;
...
public final class ClientModEvents {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(ModMenus.WARDED_JAR.get(), WardedJarScreen::new);
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.ETHEREAL_BLOOM.get(), RenderType.cutout());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.ARCANE_PILLAR.get(), RenderType.cutout());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.WARDED_JAR.get(), RenderType.cutout());
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.MAGIC_MIRROR.get(), RenderType.cutout());
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.OUTER_LANDS_PORTAL.get(), RenderType.cutout());
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.INFUSION_MATRIX.get(), RenderType.cutout());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.ARCANE_LEVITATOR.get(), RenderType.cutout());
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.LAMP_OF_GROWTH.get(), RenderType.cutout());
    ...
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.CRIMSON_CULTIST.get(), CrimsonCultistRenderer::new);
