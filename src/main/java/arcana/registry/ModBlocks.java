...
import arcana.common.blocks.EtherealBloomBlock;
...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> ETHEREAL_BLOOM = BLOCKS.register("ethereal_bloom", EtherealBloomBlock::new);
    ...
    // K2 Outer Lands portal tease
    public static final RegistryObject<Block> OUTER_LANDS_PORTAL = BLOCKS.register("outer_lands_portal",
            OuterLandsPortalBlock::new);
