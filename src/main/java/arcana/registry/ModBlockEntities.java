...
public final class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<ArcaneLevitatorBlockEntity>> ARCANE_LEVITATOR =
            BLOCK_ENTITIES.register("arcane_levitator",
                    () -> BlockEntityType.Builder.of(ArcaneLevitatorBlockEntity::new, ModBlocks.ARCANE_LEVITATOR.get()).build(null));

    public static final RegistryObject<BlockEntityType<LampOfGrowthBlockEntity>> LAMP_OF_GROWTH =
            BLOCK_ENTITIES.register("lamp_of_growth",
                    () -> BlockEntityType.Builder.of(LampOfGrowthBlockEntity::new, ModBlocks.LAMP_OF_GROWTH.get()).build(null));
