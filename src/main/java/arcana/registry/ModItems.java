...
import arcana.common.items.ItemCloudstepper;
import arcana.common.items.ItemGoggles;
import arcana.common.items.ItemGogglesAdvanced;
...
import arcana.common.items.ItemTravellerBoots;
...
import arcana.common.items.baubles.ItemCharmUndying;
...
import arcana.common.golems.GolemCoreItem;
...
public final class ModItems {
    ...
    public static final RegistryObject<Item> QUICKSILVER = ITEMS.register("quicksilver",
            () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MAGIC_TALLOW = ITEMS.register("magic_tallow",
            () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> VOID_SEED = ITEMS.register("void_seed",
            () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> CRIMSON_RITE = ITEMS.register("crimson_rite",
            () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> GOGGLES_ADVANCED = ITEMS.register("goggles_advanced", ItemGogglesAdvanced::new);
    public static final RegistryObject<Item> TRAVELLER_BOOTS = ITEMS.register("traveller_boots", ItemTravellerBoots::new);
    public static final RegistryObject<Item> CLOUDSTEPPER = ITEMS.register("cloudstepper", ItemCloudstepper::new);
    public static final RegistryObject<Item> CHARM_UNDYING = ITEMS.register("charm_undying", ItemCharmUndying::new);
    ...
    public static final RegistryObject<Item> ARCANE_LEVITATOR = ITEMS.register("arcane_levitator",
            () -> new BlockItem(ModBlocks.ARCANE_LEVITATOR.get(), new Item.Properties()));
    public static final RegistryObject<Item> MAGIC_MIRROR = ITEMS.register("magic_mirror",
            () -> new BlockItem(ModBlocks.MAGIC_MIRROR.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> LAMP_OF_GROWTH = ITEMS.register("lamp_of_growth",
            () -> new BlockItem(ModBlocks.LAMP_OF_GROWTH.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> HUNGRY_CHEST = ITEMS.register("hungry_chest",
            () -> new BlockItem(ModBlocks.HUNGRY_CHEST.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> ETHEREAL_BLOOM = ITEMS.register("ethereal_bloom",
            () -> new BlockItem(ModBlocks.ETHEREAL_BLOOM.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> OUTER_LANDS_PORTAL = ITEMS.register("outer_lands_portal",
            () -> new BlockItem(ModBlocks.OUTER_LANDS_PORTAL.get(), new Item.Properties().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> CRIMSON_CULTIST_SPAWN_EGG = ITEMS.register("crimson_cultist_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.CRIMSON_CULTIST, 0x6B1010, 0xC43A3A, new Item.Properties()));
    ...
    public static final RegistryObject<Item> SEAL_HARVEST = ITEMS.register("seal_harvest",
            () -> new GolemSealItem(GolemJob.HARVEST));
    ...
    public static final RegistryObject<Item> GOLEM_CORE_GUARD = ITEMS.register("golem_core_guard",
            () -> new GolemCoreItem(GolemCoreItem.CoreType.GUARD));
