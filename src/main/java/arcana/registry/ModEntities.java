...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<CrimsonCultist>> CRIMSON_CULTIST =
            ENTITY_TYPES.register("crimson_cultist",
                    () -> EntityType.Builder.of(CrimsonCultist::new, MobCategory.MONSTER)
                            .sized(0.6f, 1.95f)
                            .clientTrackingRange(8)
                            .build(new ResourceLocation(Arcana.MODID, "crimson_cultist").toString()));
